package top.itdn.mall.controller.interceptor;
        ...
        if(user == null || (user.getRole().intValue() != Const.Role.ROLE_ADMIN)){
            ...
            if(user == null){
                if(StringUtils.equals(className,"ProductManageController") && StringUtils.equals(methodName,"richtextImgUpload")){
                    ...
                    out.print(JsonUtil.obj2String(new ResponseJson(-1, "拦截器拦截,用户未登录", null)));
                }
            }else{
                if(StringUtils.equals(className,"ProductManageController") && StringUtils.equals(methodName,"richtextImgUpload")){
                    Map resultMap = Maps.newHashMap();
                    ...
                    out.print(JsonUtil.obj2String(new ResponseJson(-1, "拦截器拦截,用户无权限操作", null)));
                }
            }
            out.flush();
